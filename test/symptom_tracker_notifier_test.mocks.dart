...
import 'package:myapp/domain/repositories/symptom_repository.dart' as _i4;
...
class MockSymptomRepository extends _i1.Mock implements _i4.SymptomRepository {
  MockSymptomRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Stream<List<_i6.SymptomLog>> watchAllSymptomLogs(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #watchAllSymptomLogs,
          [userId],
        ),
        returnValue: _i5.Stream<List<_i6.SymptomLog>>.empty(),
      ) as _i5.Stream<List<_i6.SymptomLog>>);

  @override
  _i5.Future<void> addSymptomLog(_i6.SymptomLog? log) => (super.noSuchMethod(
        Invocation.method(
          #addSymptomLog,
          [log],
        ),
  ...
  @override
  _i5.Future<void> updateSymptomLog(_i6.SymptomLog? log) => (super.noSuchMethod(
        Invocation.method(
          #updateSymptomLog,
          [log],
        ),
  ...
  @override
  _i5.Future<void> deleteSymptomLog(
    int? id,
    String? userId,
  ) =>
      (super.noSuchMethod(
